...
if (win.latitude!='' && win.longitude!=''){
	mountainView2.latitude = win.latitude;
	mountainView2.longitude = win.longitude;
	mountainView2.title = win.index;
	mountainView2.subtitle = win.ttl;
} else {
	mountainView2.latitude = 55.689125;
	mountainView2.longitude =37.623410;
}
